...
@SpringBootTest
public class ExtractFoodStrategyTest {
    @InjectMocks
    ...
    public void shouldFailBecauseCardNotFound() {
        ...
        try {
            extractFoodStrategy.buy(purchaseRequestDTO);
        } catch (Exception e) {
    ...
    public void shouldFailBecauseCardTypeIsInvalid() {
        ...
        try {
            ...
            assert e.getMessage().equals("Tipo de cartão incompatível com o tipo do estabelecimento");
        }
    }
    ...
    @Test
    public void shouldSaveExtractWithCashBackCorrectly() {
        when(cardRepository.findCardByCardNumber(1)).thenReturn(Optional.of(Card.builder()
                        .id(1)
                        .cardType(CardType.FOOD)
                        .cardNumber(1)
        ...
        assert purchaseRequestDTO.getValue().equals(90.0);
    }
